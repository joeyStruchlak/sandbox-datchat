...
//   static EXPORT_KEYWORDS = ["export", "download", "save", "file", "csv", "excel", "json", "spreadsheet", "extract"]
...
//    */
//   static isDataQuery(input) {
//     const dataQueryCount = this.DATA_QUERY_KEYWORDS.filter((keyword) => input.includes(keyword)).length
...
//    */
//   static isConversational(input) {
//     return this.CONVERSATIONAL_KEYWORDS.some((keyword) => input.includes(keyword))
//   }
...
//     // Count matching keywords
//     const keywordMatches = this.DATA_QUERY_KEYWORDS.filter((keyword) => input.includes(keyword)).length
...
//     const hasExportKeyword = this.EXPORT_KEYWORDS.some((keyword) => lowerInput.includes(keyword))
//     const hasFormatKeyword = ["csv", "excel", "json", "spreadsheet", "file"].some((format) =>
//       lowerInput.includes(format),
//     )

//     return hasExportKeyword && (hasFormatKeyword || lowerInput.includes("this") || lowerInput.includes("data"))
//   }
...
//     if (lowerInput.includes("excel") || lowerInput.includes("xlsx") || lowerInput.includes("spreadsheet")) {
//       return "excel"
//     }
